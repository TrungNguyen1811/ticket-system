...
interface ClientCardProps {
  ...
  export const ClientCard: React.FC<ClientCardProps> = ({ clientName, clientEmail, ticketId}) => {
    ...
    const clientId = clients?.data?.data?.find((client) => client.name === clientName)?.id;
