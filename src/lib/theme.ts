...
export const buttonStyles = {
  ...
  ghost: {
    ...
    hover: 'hover:bg-secondary-100 hover:text-secondary-900 transition-all duration-200',
...
export const inputStyles = {
  ...
  focus: 'focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 focus:outline-none transition-all duration-200',
