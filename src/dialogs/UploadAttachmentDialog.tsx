...
export function UploadAttachmentDialog({ open, onOpenChange, ticketId }: UploadAttachmentDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await attachmentService.uploadAttachment(ticketId, formData as AttachmentFormData)
